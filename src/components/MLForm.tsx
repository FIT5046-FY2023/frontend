...
import {
  MLTypes,
  mlTypesList,
} from "../enums/machineLearningTasks";
import {
...
export interface MLData {
  mlType: MLTypes | "";
  mlAlgo: RegressionAlgorithmsApiValues | ClassificationAlgorithmsApiValues | 
  "";
...
const MLForm = ({ formRef }: { formRef: React.MutableRefObject<FormikProps<MLDataList> | null>}) => {
  return (
    <div>
      <Formik
                      ...
                      <div className="row" key={index}>
                        ...
                        {!!data.mlAlgo &&
                          [
                            ...
                            <div className="col">
                              <label htmlFor={`MLData.${index}.mlOptions`}>
                                Algo Parameters
                              </label>
                              <Stack spacing={2} maxWidth={"40vw"} width={"100%"}>
                              <label htmlFor={`MLData.${index}.mlOptions.trees`}>
                               # Number of Trees
                              </label>
                              <Field
                              ...
                              <label htmlFor={`MLData.${index}.mlOptions.maxDepth`}>
                               Max tree depth
                              </label>
                              <Field
                          ...
                          [
                            ...
                            <div className="col">
                              ...
                              <label htmlFor={`MLData.${index}.mlOptions.weights`}>
                               Weights
                              </label>
                              <Field
                              ...
                              >
                                ...
                                {["uniform", "distance"].map((weightType) => (
                                   
                                  <option key={weightType} value={weightType}>
                                    {weightType}
                                  </option>))}
                              </Field>
                              <ErrorMessage
